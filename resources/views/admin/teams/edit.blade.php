					...
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="name" id="name" placeholder="Name" value="{{ $team->name }}" required />
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-12">
							<div class="form-group">
								...
								<select class="form-control" style="width: 100%;" id="is_status" name="is_status" required >
									...
									<option value="1" {{ $team->is_status == 1 ? 'selected' : '' }} >Show</option>
									<option value="0" {{ $team->is_status == 0 ? 'selected' : '' }} >Hide</option>
								  </select>
							</div>
						</div>
					</div>
